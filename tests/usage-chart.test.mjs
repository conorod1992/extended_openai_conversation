...
assert.match(usageSource, /Cached input<\/strong> is input recognised as cached by the provider/);
assert.match(usageSource, /included in total tokens/);
assert.match(usageSource, /may be billed at a lower rate/);
