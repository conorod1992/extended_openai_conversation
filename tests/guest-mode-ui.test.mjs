...
assert.match(panel, /labels are the easiest way/);
...
assert.match(panel, /On makes all current and future Knowledge sources available to guests/);
assert.match(panel, /On makes all current and future eligible custom functions available to guests/);
assert.match(panel, /Turning this off never ends, shortens, or weakens an active Guest restriction/);
