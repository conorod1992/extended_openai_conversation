## Objective
- Let gpt know about area information, so [execute_services](https://github.com/conorod1992/extended_openai_conversation/tree/v1.0.2/examples/function/area#execute_services) can be called using `area_id`
