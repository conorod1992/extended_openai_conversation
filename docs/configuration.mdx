...
<AccordionGroup>
  ...
  <Accordion title="Persistent memory">
    **Default**: Off
    ...
    Store selected, concise facts locally across conversations. You can separately enable automatic creation and choose how many relevant memories are retrieved automatically. Existing agents remain unchanged until you opt in.

    See [Persistent memory](/persistent-memory) for storage, privacy, user isolation, management actions, and examples.
  </Accordion>
