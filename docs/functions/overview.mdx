...
<Tip>
Agents with many functions can use optional **Function Groups** to keep full schemas always available or load them only when needed. Existing function YAML does not change. See [Function Groups](/features/function-groups).
</Tip>
