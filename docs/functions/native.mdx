...
Native functions are built-in capabilities provided directly by the Extended OpenAI Conversation (Responses) component. These functions are implemented in Python and offer core functionality.
