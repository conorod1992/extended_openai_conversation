"""Live capability and memory-provider guards retained with the processing stack."""
...
def _install_runtime_configuration_lifecycle() -> None:
    """Retain live capability gates at memory retrieval and execution boundaries."""
    from .conversation import ExtendedOpenAIAgentEntity
