...
class ExtendedOpenAIManagementPanel extends HTMLElement {
  ...
  _styles() { return `
    ...
    .editor-meta-actions,.prompt-section-badges{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.prompt-preview-dialog{height:min(900px,calc(100vh - 28px))}.prompt-preview-body{grid-template-rows:auto auto minmax(260px,1fr) auto auto;max-height:none;height:calc(100% - 142px)}.prompt-preview-label{display:grid;grid-template-rows:auto minmax(0,1fr);gap:7px;min-height:0}.prompt-preview-output{box-sizing:border-box;width:100%;height:100%;min-height:320px;resize:none;white-space:pre;overflow:auto;line-height:1.5}.prompt-section-badge{display:inline-flex;padding:4px 9px;border-radius:999px;background:var(--secondary-background-color);color:var(--secondary-text-color);font-size:11px}.prompt-section-badge.stable{background:color-mix(in srgb,var(--success-color,#0f9d58) 13%,transparent);color:var(--success-color,#0f9d58)}.prompt-section-badge.volatile{background:color-mix(in srgb,var(--warning-color,#f9ab00) 15%,transparent);color:var(--warning-color,#b26a00)}.prompt-preview-notes{margin:0;padding-left:20px;color:var(--secondary-text-color);font-size:12px;line-height:1.5}.prompt-preview-notes:empty{display:none}
