...
class ExtendedOpenAIManagementPanel extends HTMLElement {
  ...
  _styles() { return `
    ...
    @media(max-width:679px){.form-grid,.general-grid{grid-template-columns:1fr}.config-surface{padding:0 18px 92px}.config-section{padding:28px 0}.config-jumps{margin-inline:-4px}.rule-headings{display:none}.rule-row{grid-template-columns:1fr}.mobile-label{display:block}.rule-actions{padding-top:0}.save-bar{align-items:stretch;flex-direction:column;bottom:6px;margin-inline:-8px}.save-bar .actions{display:grid;grid-template-columns:1fr 1fr}.tool-dialog{box-sizing:border-box;left:6px;top:6px;margin:0;width:calc(100vw - 12px);max-width:calc(100vw - 12px);height:calc(100vh - 12px);max-height:calc(100vh - 12px);overflow:hidden}.tool-dialog-body{padding:12px}.tool-yaml-editor{min-height:0}.tools-surface{padding:18px}.tools-actions{justify-content:stretch}.tools-actions button{flex:1}.tools-actions .validation{width:100%;order:-1}}
  `; }
}
