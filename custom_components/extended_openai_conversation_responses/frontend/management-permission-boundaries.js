...
export function installManagementPermissionBoundaries(Panel) {
  ...
  if (typeof Panel !== "function") {
    ...
    return registry.whenDefined(PANEL_TAG).then(() => installManagementPermissionBoundaries(registry.get(PANEL_TAG)));
  }
