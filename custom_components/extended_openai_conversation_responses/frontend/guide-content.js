export const GUIDE_TOPICS = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Use narrow, exact matching for sensitive actions such as locks, alarms, or garage doors. Request Rules are included in each agent's private full backup."
      },
      {
        type: "note",
