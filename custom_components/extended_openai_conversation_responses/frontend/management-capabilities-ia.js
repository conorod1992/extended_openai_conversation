...
export function installManagementCapabilitiesIA(Panel) {
  ...
  if (typeof Panel !== "function") {
    ...
    return registry.whenDefined("extended-openai-management-panel").then(() => installManagementCapabilitiesIA(registry.get("extended-openai-management-panel")));
  }
